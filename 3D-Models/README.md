...
The model **CB-Turntable-Segment.stl** needs to be printed four times and need to be attached to the top of a 12" to 13" Lazy Susan to form a full circle. These provide placement markers for your jars and the gear drive that the model **CB-Flange-Gripper.stl** meshes with. You will want to apply some sort of non-skid surface or silicone coasters to the placement markers to keep your jars in place and immune to vibrations. Just make sure that these four segments are perfectly centered and there are no gaps between them.
