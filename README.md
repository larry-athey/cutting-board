...
No, Genio and iStill don't have this capability either. The most they can do is pause the run so you can toss the heads/foreshots based on the volume and ABV of the wash in your boiler. Even still, that's just an approximation based on simple math, it's nothing high tech.
