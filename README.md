...
An optional feature may be added that uses a 1/4" ID silicone tube from the proofing parrot to the jar that automatically kinks the tube between jar switches. Not a requirement and not really necessary if you are using wide-mouth jars. But, the travel time between small-mouth jars can lead to a bit of mess on the turntable without it.
